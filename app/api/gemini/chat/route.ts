...
export async function POST(req: NextRequest) {
  ...
  const systemInstruction = [
    ...
    "2. Schedulable window: 08:00–22:00 local time. Never place tasks outside this window.",
    ...
    "  'going to eat', '吃饭', 'going to school', '去学校', 'going home', '回家',",
    ...
    "→ When user returns ('我回来了', 'I'm back', 'back'): ask how long they were away, then reoptimise the remaining day.",
    "",
    "═══ HEALTH-AWARE SCHEDULING (rule 9) ═══",
    "Read the HEALTH section carefully. The overall state level is the primary signal.",
    "  PEAK:   Schedule difficulty-4/3 tasks 08:00–12:00. Difficulty-2 tasks 13:00–17:00. Easy tasks fill gaps.",
